...
experiment.Y = {
  code: 'O-BA-BO', //trial order: operant trials, baseline action, baseline outcome
  password: '98',
  randomDelayMin: 1000,
  randomDelayMax: 1001,
  ...
  sounds: {
    ...
    getReady: [{}, //file: 'media/250-440Hz_44100Hz_16bit_1000ms.wav'
      {} //file: 'media/500-880Hz_44100Hz_16bit_1000ms.wav'
    ],
    feedback: [{
      duration: 100 /*in msec*/ ,
      pitch: 1000 /*in Hz*/
    }, {
      duration: 100 /*in msec*/ ,
      pitch: 500 /*in Hz*/
  ...
  passwordScreen: {
    title: 'Get ready',
    content: '<p>Please enter the code provided by the research group to start the first part of the experiment.<br/>The code is 98.</p><br/><div id="pre_password"><input type="password" id="pre_password_text" size="10" /></div><br/><p>The experiment will start once the correct code is entered.</p><br/><br/><br/><br/><br/><br/><br/><br/><p>Press \'OK\' to start.</p>'
  },
  phases: [{
    ...
    trials: [
               ...
               { cycle: 2560, tone: 250, response: 'outcome' },
               { cycle: 2560, tone: 750, response: 'outcome' },
               { cycle: 2560, tone: 750, response: 'text2' },
               { cycle: 2560, tone: 250, response: 'outcome' },
               { cycle: 2560, tone: 750, response: 'outcome' },
               { cycle: 2560, tone: 750 },
               { cycle: 2560, tone: 250 },
    ...
    trials: [
               ...
               { cycle: 2560, tone: 250, response: 'outcome' },
               { cycle: 2560, tone: 750, response: 'outcome' },
               { cycle: 2560, tone: 750, response: 'text3' },
               { cycle: 2560, tone: 250, response: 'outcome' },
               { cycle: 2560, tone: 750, response: 'outcome' },
               { cycle: 2560, tone: 750 },
               { cycle: 2560, tone: 250 },
    ...
    trials: [
               ...
               { cycle: 2560, tone: 750 },
               { cycle: 2560, tone: 250 },
               { cycle: 2560, tone: 250, response: 'text4' },
               { cycle: 2560, tone: 750 },
               { cycle: 2560, tone: 250 },
               { cycle: 2560, tone: 750 },
               { cycle: 2560, tone: 250 },
    ...
    screen: {
      ...
      content: '<p>Press \'OK\' to move to the next screen where you will complete a short questionnaire and then proceed back to Prolific.</p>'
    }
  }],
  postScreens: [
    //debriefing screen here before final screen
    {
      title: 'Debriefing Questionnaire',
      type: 'questionaire',
      content: '<div id="Question1">  <p>1. Did you use a strategy to help maximize your performance on this task?</p>  <p>    <input id="q1_yes" name="q1" type="radio" value="yes"  /> Yes     <input id="q1_no" name="q1" type="radio" value="no"  /> No  </p>  <div id="ifQ1Yes" style="display:none;">    <p> If yes, please elaborate: </p>    <textarea id="q1_text" name="q1_text" cols="20" rows="1"></textarea>  </div></div><div id="Question2" style="display:none;">  <p> 2. Did you tend to systematically press the spacebar when the dot was on a particular position on the clock? If so, what was that position? </p>  <textarea id="q2_text" name="q2_text" cols="20" rows="1"></textarea></div><div id="Question3" style="display:none;">  <p>3. Was this strategy related to the way things were presented on the screen?</p>  <p>    <input id="q3_yes" name="q3" type="radio" value="yes"  /> Yes     <input id="q3_no" name="q3" type="radio" value="no"  /> No  </p></div><div id="Question4" style="display:none;">  <p>4. Was this strategy related to the size of your monitor?</p>  <p>    <input id="q4_yes" name="q4" type="radio" value="yes"  /> Yes     <input id="q4_no" name="q4" type="radio" value="no"  /> No  </p></div><div id="Question5" style="display:none;">  <p>5. Was this strategy related to your distance away from the monitor?</p>  <p>    <input id="q5_yes" name="q5" type="radio" value="yes"  /> Yes     <input id="q5_no" name="q5" type="radio" value="no"  /> No  </p></div><div id="Question6" style="display:none;">  <p>6. Did you change your strategy at any point during the task?</p>  <p>    <input id="q6_yes" name="q6" type="radio" value="yes"  /> Yes     <input id="q6_no" name="q6" type="radio" value="no"  /> No  </p>  <div id="ifQ6Yes" style="display:none;">    <p> If yes, please elaborate: </p>    <textarea id="q6_text" name="q6_text" cols="20" rows="1"></textarea>  </div></div>'
    }, {
      title: 'Thank you!',
      content: '<p>Your responses will be added to those of the other participants and analyzed statistically.</p><br/><p>Thank you very much for your participation.</p><br/><p>If you are interested in these kind of studies, please visit our lab website to learn more about our research: <a href="https://sites.rutgers.edu/ccm-lab/">HCCLAB WEBSITE</a>.</p><br/><br/><strong><mark class="blue">Please click <a href="https://app.prolific.co/submissions/complete?cc=F79B354C">HERE</a> to go back to Prolific.</mark></strong></p><br/><p><strong>*You must click on the link above in order to receive payment for your participation.*</strong></p>'
    }
  ]
};
