...
experiment.Y = {
  ...
  preScreens: [
    ...
    },
    {
      ...
      content: '<p><strong>Please ensure that you are in a quiet location before beginning the experiment.</strong> Please check the boxes to indicate you have read and understand each section.</p><br/><p><input type= "checkbox"><label>At the beginning of each trial you will see a “GET READY” message. The dot on the clock on your screen will then begin rotating. In this first section, you will be asked to press the spacebar at a time of your choosing after the dot on the clock has completed one full rotation. Your keypress will cause the computer to play a tone.</label></p><br/><p><input type= "checkbox"><label><strong>Your task will be to pay attention to where the dot was on the clock when you <mark class="red">pressed the spacebar</mark> AND when you <mark class="blue">heard the tone.</mark></strong></label></p><br/><p>Press "Next" to move to the next screen where the instructions are continued.</p>'
    },
    {
