...
experiment.W = {
  code: 'BO-BA-O', //trial order: baseline outcome, baseline action, operant trials
  password: '96',
  randomDelayMin: 1000,
  randomDelayMax: 1001,
  ...
  passwordScreen: {
    title: 'Get ready',
    content: '<p>Please enter the code provided by the research group to start the first part of the experiment.<br/>The code is 96.</p><br/><div id="pre_password"><input type="password" id="pre_password_text" size="10" /></div><br/><p>The experiment will start once the correct code is entered.</p><br/><br/><br/><br/><br/><br/><br/><br/><p>Press \'OK\' to start.</p>'
  },
  phases: [{
    ...
    screen: {
      title: '**********WARNING**********',
      content: '<p>Please check each box to indicate you have read and understood these additional instructions.</p><br/><p><input type= "checkbox"><label>Please <strong>DO NOT press anything</strong> when you see "GET READY!".</label></p><br/><p><input type= "checkbox"><label>Please <strong>DO NOT press the spacebar <u>more than once</u></strong> per trial!</label></p><br/><p><input type= "checkbox"><label>If you press the spacebar and nothing happens <strong>DO NOT PRESS AGAIN</strong>.</label></p><br/><p><input type= "checkbox"><label>If you do not hear anything after you press the spacebar, wait until the next trial and try again. <strong>DO NOT PRESS MORE THAN ONCE PER TRIAL.</strong></label></p></br><p>Press "OK" to start the next block.</p>',
    }
  }, {
    ...
    screen: {
      title: '**********WARNING**********',
      content: '<p>Please check each box to indicate you have read and understood these additional instructions.</p><br/><p><input type= "checkbox"><label>Please <strong>DO NOT press anything</strong> when you see "GET READY!".</label></p><br/><p><input type= "checkbox"><label>Please <strong>DO NOT press the spacebar <u>more than once</u></strong> per trial!</label></p><br/><p><input type= "checkbox"><label>If you press the spacebar and nothing happens <strong>DO NOT PRESS AGAIN</strong>.</label></p><br/><p><input type= "checkbox"><label>If you do not hear anything after you press the spacebar, wait until the next trial and try again. <strong>DO NOT PRESS MORE THAN ONCE PER TRIAL.</strong></label></p></br><p>Press "OK" to start the last block.</p>',
    }
  }, {
