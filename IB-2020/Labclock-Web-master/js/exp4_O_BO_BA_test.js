...
experiment.Z = {
  ...
  preScreens: [
    ...
    {
      title: 'Demo',
      content: '<p>Clock in demo mode. Press \'Next\' when you are ready to start the experiment.</p><div id="demo_clock"><div id="demo_marks"><img src="img/dot.png" width="510" height="510"  id="demo_dot"/></div></div>'
    }
  ],
  passwordScreen: {
    title: 'Get ready',
  ...
  phases: [
        ...
        },
    {
      ...
      screen: {
        ...
        content: '<p>You have completed the second part of the experiment.</p><br/><p>This last section will be similar to the previous section except this time your task is to <strong>wait for one full rotation of the dot before you press the spacebar</strong>.</p><br/><p>At the end of each trial, you will be asked to recall the position of the dot on the clock when you <strong>pressed the spacebar</strong>. To do that, simply use your mouse to click the position on the clock where you thought the dot was.</p><br/><p>Once you are satisfied with your response, click “OK” and the next trial will start.</p><br/><br/><br/><br/><p>Press "OK" to start the next part of the experiment.</p>',
      }
    },
    {
