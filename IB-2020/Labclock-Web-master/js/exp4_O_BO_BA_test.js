...
experiment.Z = {
  code: 'O-BO-BA', //trial order: operant trials, baseline outcome, baseline action
  password: '99',
  randomDelayMin: 1000,
  randomDelayMax: 1001,
  ...
  passwordScreen: {
    title: 'Get ready',
    content: '<p>Please enter the code provided by the research group to start the first part of the experiment.<br/>The code is 99.</p><br/><div id="pre_password"><input type="password" id="pre_password_text" size="10" /></div><br/><p>The experiment will start once the correct code is entered.</p><br/><br/><br/><br/><br/><br/><br/><br/><p>Press \'OK\' to start.</p>'
  },
  phases: [{
