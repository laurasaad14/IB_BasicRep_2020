...
experiment.B = {
  code: 'baseline-outcome trials',
  password: '2',
  randomDelayMin: 1000,
  randomDelayMax: 1001,
  postResultsURL: 'datasent.asp', //need to change this
  generateCSV: true,
  responseKey: ' ',
  sounds: {
    demo: [
  ...
  messages: {
    ...
    trialSelecting: 'Please place the dot where it was on the clock when you FIRST HEARD THE TONE. Please do your best to be as accurate as possible. Click OK when you are ready to move forward.<br/>',
  ...
  preScreens: [
    ...
    {
      title: 'Thank you - GET FROM CONSENT FORM',
    ...
    {
      title: 'Instructions',
      content: '<p>At the beginning of each trial you will hear a sound and see a “GET READY” message. The dot on the clock on your screen will then begin rotating.</p><br/><p>Your task is to pay attention to when the tone is played through the speaker.</p><br/><p>At the end of each trial, you will be asked to recall the position of the dot on the clock when you first HEARD THE TONE. To do that, simply use your mouse to click on the clock and place the dot at the correct position.</p><br/><p>Once you are satisfied with your response, click “OK” and the next trial will start.</p><br/><p>On the next screen you will see a clock in demo mode to help you familiarize yourself with the task.</p>'
    },
    {
      title: 'Demo',
  ...
  phases: [
    ...
    {
      description: 'Binding3',
      progress: false,
      scramble: false,
      trials: [
        { cycle: 2560, tone: Math.random() * (2560 - 1280) + 1280, nopress: true },
        { cycle: 2560, tone: Math.random() * (2560 - 1280) + 1280, nopress: true },
        { cycle: 2560, tone: Math.random() * (2560 - 1280) + 1280, nopress: true },
        { cycle: 2560, tone: Math.random() * (2560 - 1280) + 1280, nopress: true },
        { cycle: 2560, tone: Math.random() * (2560 - 1280) + 1280, nopress: true },
  ...
  postScreens: [
    {
        title: 'Thank you!',
        content: '<p>Your responses will be added to those of the other participants and analyzed statistically.</p><br/><p>Thank you very much for your collaboration.</p><br/><p>If you are interested in this kind of studies, please visit the Experiments Tab on our lab website: <a href="https://sites.rutgers.edu/ccm-lab/">HCCL LAB WEBSITE</a>.</p>'
      }
  ]
};
