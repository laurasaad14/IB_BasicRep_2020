...
experiment.C = {
  ...
  messages: {
    ...
    trialSelecting: 'Please place the dot where it was on the clock when you PRESSED THE SPACEBAR.<br/>Please do your best to be as accurate as possible. Click OK when you are ready to move forward.',
  ...
  preScreens: [
    ...
    {
      title: 'Instructions',
      content: '<p>At the beginning of each trial you will hear a sound and see a “GET READY” message. The dot on the clock on your screen will then begin rotating.</p><br/><p>Your task is to wait for one full rotation of the dot before you press the SPACEBAR.</p><br/><p>At the end of each trial, you will be asked to recall the position of the dot on the clock when you first PRESSED THE SPACEBAR. To do that, simply use your mouse to click on the clock and place the dot at the correct position.</p><br/><p>Once you are satisfied with your response, click “OK” and the next trial will start.</p><br/><p>On the next screen you will see a clock in demo mode to help you familiarize yourself with the task.</p>'
    },
    {
      title: 'Demo',
